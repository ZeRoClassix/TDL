...
export default {
    ...
    template: `
        ...
        <main v-else-if="error" class="page-contacts-wrapper" style="display: block; overflow-y: auto; height: 100%;">
        ...
        <main v-else-if="editors && editors.length > 0" class="page-contacts-wrapper" style="display: block; overflow-y: auto; height: 100%;">
            <div class="page-contacts">
        ...
        <main v-else class="page-contacts-wrapper" style="display: block; overflow-y: auto; height: 100%;">
            <div class="page-contacts">
                <div class="contacts-hero">
                    <div class="contacts-kicker">Official Team Directory</div>
                    <h1>Contacts</h1>
